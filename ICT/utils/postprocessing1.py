"""Postprocessing script for CBCT segmentation."""
import sys
import os
...
if __name__ == "__main__":
    sys.path.insert(1, os.path.join(os.getcwd(), 'ToothSwin'))
...
# example
# output_postprocessed = post_processing_segmentation(model_output, instance_ground_truth=gt_image, device=device,
